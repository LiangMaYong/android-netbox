...
import com.liangmayong.netbox.defualts.OnDefualtObjectListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Netbox.server(GithubService.class).path("/list").param("key", "param").exec(this, new OnDefualtObjectListener<String>() {
            @Override
